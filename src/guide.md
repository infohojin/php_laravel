---
layout: docs
title: "📘 지니샵(JinyShop) 도서 쇼핑몰 14주 핸드온 라라벨 마스터 작업 가이드"
---
...
> 라라벨 Blade의 `{{ $var }}` 문법은 Liquid 템플릿 태그와 형식이 같으므로, 모든 마크다운 파일의 본문은 `
...
| `Liquid Exception: Unknown tag ...` | 라라벨 Blade `{{ ... }}` 문법 충돌 | 본문 시작에 `
